        ...
        while True:
            ...
            try:
                print(tnow + "," + str(data['Bin 0']) + "," + str(data['Bin 1']) + "," + str(data['Bin 2']) + "," + str(
                    ...
                    data['Bin 21']) + "," + str(data['Bin 22']) + "," + str(data['Bin 23']) + "," + str(
                    data['Bin 24']) + "," + str(data['period']) + "," + str(data['FlowRate']) + "," + str(
                    data['Temp']) + "," + str(data['RH']) + "," + str(data['pm1']) + "," + str(
                    data['pm2.5']) + "," + str(data['pm10']) + "," + str(data['Check']), file=f)
                print(OPCNAME, " Time", tnow, " Temp:", str(data['Temp']), " RH:", str(data['RH']), " PM1:",
